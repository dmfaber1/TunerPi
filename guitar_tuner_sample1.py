...
# Darrell - This code came from https://www.instructables.com/Raspberry-Pi-Guitar-Tuner/
# I cleaned it up a bit, no idea if it works
...
while True:
    ...
    if frequencyoutput:
        ...
        print("DARRELL: thefreq = {0}".format(thefreq))
        print("DARRELL: adjfreq = {0}".format(adjfreq))
